...
A tiny one-page site for a home sourdough bakery in Atlanta. Pre-order a few loaves each day, pickup or $2 Atlanta delivery.
...
For $2 Atlanta delivery: easiest to handle out-of-band — the success page / your follow-up text confirms whether they want pickup or delivery and you collect the $2 via Venmo / a separate $2 Stripe link. Later you can fold it into a single link with a shipping option.
